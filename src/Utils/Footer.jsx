      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
          <div class="col-span-2 md:col-span-4 xl:pr-8">
            ...
            <p class="text-base leading-relaxed text-gray-600 mt-7">
              Join us! We offer expert mobile/web development, digital
              marketing, and graphic design. Get a free consultation to ensure
            ...
            <a
              href="#"
              title=""
              class="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-yellow-300 rounded-full lg:mt-5 hover:bg-yellow-400 focus:bg-yellow-400 mt-7"
            >
              <svg
                class="w-6 h-6"
          ...
          <div class="lg:col-span-2">
            ...
            <ul class="mt-6 space-y-5">
              ...
              <a 
              href="/"
                  className="block px-3 py-2 text-sm text-gray-800 transition  hover:text-orange-600 duration-300 ease-in-out rounded md:bg-transparent md:p-0 hover:text-black hover:underline-yellow"
          ...
          <div class="lg:col-span-2">
            ...
            <ul class="mt-6 space-y-5">
              <li>
                <a
                  href="https://www.linkedin.com/in/wrenix-company-55bb772a4/"
                  title=""
                  class="flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600"
                >
                  {" "}
              ...
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=61554167503861&sfnsn=wa&mibextid=RUbZ1f"
                  title=""
                  class="flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600"
                >
                  {" "}
              ...
              <li>
                <a
                  href="https://www.youtube.com/@Wrenixglobal"
                  title=""
                  class="flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600"
                >
                  {" "}
          ...
          <div class="lg:col-span-2">
            <p class="text-base font-semibold text-gray-900">Contact</p>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <p class="text-sm text-gray-600">
            © Copyright 2024, All Rights Reserved by Wrenix (PVT) LTD
          </p>
