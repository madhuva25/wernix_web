          ...
          <div class="max-w-5xl mx-auto mt-12 sm:mt-16">
              ...
              <div class="overflow-hidden bg-white rounded-xl">
                <div class="p-6">
                  ...
                  <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">
                    Thissamaharama, Hambanthota , Sri Lanka
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mt-6 overflow-hidden bg-white rounded-xl">
              <div class="px-6 py-12 sm:p-12">
                ...
                <form ref={form} onSubmit={sendEmail} class="mt-14">
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div class="sm:col-span-2">
                      <button
                        type="submit"
                        class="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-black dark:bg-yellow-300 transition-all duration-200 border border-transparent rounded-md focus:outline-none dark:hover:bg-yellow-400   "
                      >
                        Send
                      </button>
                    </div>
